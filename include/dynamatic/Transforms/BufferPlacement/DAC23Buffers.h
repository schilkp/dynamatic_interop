//===- DAC23Buffers.h - DAC'23 buffer placement -----------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// DAC'23 iterative buffer placement, as presented in
// https://ieeexplore.ieee.org/document/10247686
//
// This mainly declares the `DAC23Placement` class, which inherits the abstract
...
// under the `dynamatic::buffer::dac23` namespace, as to not create name
// conflicts for common structs with other implementors of
// `BufferPlacementMILP`.
//
//===----------------------------------------------------------------------===//

#ifndef DYNAMATIC_TRANSFORMS_BUFFERPLACEMENT_DAC23BUFFERS_H
#define DYNAMATIC_TRANSFORMS_BUFFERPLACEMENT_DAC23BUFFERS_H
...
#endif // DYNAMATIC_TRANSFORMS_BUFFERPLACEMENT_DAC23BUFFERS_H